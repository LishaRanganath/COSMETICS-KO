...
if(isset($_POST['add_product'])){
  ...
  $insert_query=mysqli_query($conn,"INSERT INTO `makeup`(pname,brand,price,image) VALUES('$p_name','$p_brand','$p_price','$p_image')") or die('query failed');
  if($insert_query){
...
if(isset($_GET['delete'])){
  ...
  $delete_query=mysqli_query($conn,"DELETE FROM `makeup` WHERE pid=$delete_id") or die('query failed');
  if($delete_query){
...
if(isset($_POST['update_product'])){
  ...
  $update_query=mysqli_query($conn,"UPDATE `makeup` SET pname='$update_p_pname',brand='$update_p_brand', price='$update_p_price',image='$update_p_image' WHERE pid='$update_p_id'");
  if($update_query){
  ...
  <div class="container">
    ...
    <section class="display-product-table">
      <table>
        ...
        <tbody>
          <?php
             $select_products=mysqli_query($conn,"SELECT * FROM `makeup`");
           ...
           <tr>
             ...
             <td>
               <a href="admin2.php?delete=<?php echo $row['pid']; ?>" class="delete-btn" onclick="return confirm('are you sure you want to delete this?');"><i class="fas fa-trash"></i>DELETE</a>
      ...
      <section class="edit-form-container">
        <?php
         if(isset($_GET['edit']));
          $edit_id=$_GET['edit'];
          $edit_query=mysqli_query($conn,"SELECT * FROM `makeup` WHERE pid=$edit_id");
